          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-3">
              {data.challenges.map((c, i) => (
                <li key={i} className="flex items-start gap-3 text-lg text-muted-foreground leading-relaxed">
        ...
        >
          <motion.div variants={itemVariants} className="mb-12">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white">Impact</h2>
            </div>
            <p className="text-muted-foreground text-lg">Real outcomes delivered after implementation.</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {data.impact.map((item, i) => (
              ...
              >
                ...
                <p className="text-white/90 text-base leading-relaxed relative z-10">{item}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
      ...
      <Section className="border-t border-white/5 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-xl mx-auto">
            Talk to our team to see how Lumien can power your financial operations.
          </p>
