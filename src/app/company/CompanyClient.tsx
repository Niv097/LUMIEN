...
export default function CompanyClient({ data }: { data: CompanyData | null }) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <Section className="py-12 md:py-24 bg-gradient-to-b from-white/5 to-transparent border-y border-white/5 flex flex-col justify-center">
      ...
      <Section className="py-12 md:py-24 text-center flex flex-col justify-center">
